...
const itemsURL = "foodItems.json";
const tablesURL = "tablesList.json";
...
function loadTables(){
    ...
    }).catch(error => console.log("Tables JSON File is not found"))
}
...
function resetTable(event){
    ...
    tableData=JSON.parse(localStorage.getItem("tables"));
    alert("The total bill is "+tableData[0].totalPrice);
    resetBillingTable();
